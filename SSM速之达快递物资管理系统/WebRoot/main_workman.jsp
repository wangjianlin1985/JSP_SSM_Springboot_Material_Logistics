...
<jsp:include page="check_workman_logstate.jsp"/>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	<div class="logo">速之达物流网系统后台管理</div>
	<div class="logout">您好，<%=session.getAttribute("workman")%> | <a href="logout">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_workman.js"></script>
