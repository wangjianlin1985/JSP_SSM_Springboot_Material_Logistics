...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">速之达物流网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Cangku/frontlist">仓库查询</a></li>
                <li><a href="<%=basePath %>WuziClass/frontlist">物资种类</a></li>
                <li><a href="<%=basePath %>Wuzi/frontlist">物资查询</a></li>
                <li><a href="<%=basePath %>Ruku/frontlist">入库查询</a></li>
                <li><a href="<%=basePath %>Chuku/frontlist">出库查询</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
	  			...
	  			<li><a href="<%=basePath %>WorkMan/workMan_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;工作人员注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Wuzi/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的快递物资查询</a></li>
