		       ...
		       text: "入库管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Ruku/ruku_workmanAdd.jsp"
			    	   	},
			    		{
			    	   		text: "我的入库管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Ruku/ruku_workmanQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "出库管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Chuku/chuku_workmanAdd.jsp"
			    	   	},
			    		{
			    	   		text: "我登记的出库记录",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Chuku/chuku_workmanQuery_result.jsp"
			    	    }
			    	   ]
			},{
			       text: "系统管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-edit",
			    		    url: "WorkMan/workMan_selfModify.jsp"
			    	   	}
			    	   ]
			}],
